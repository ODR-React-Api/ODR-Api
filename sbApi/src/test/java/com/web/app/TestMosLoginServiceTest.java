...
public class TestMosLoginServiceTest {
    ...
    public void test1() {
        ...
        sessionInfo.setSessionId("0ba1bfba-aab6-4e22-b30a-3140482fa9b7");
        sessionInfo.setPlatformId("001");
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonData = objectMapper.writeValueAsString(sessionInfo);

        // 请求并接收返回值
        MvcResult mvcResult = mockMvc.perform(post("/mosLogin/getPlatformId").contentType(MediaType.APPLICATION_JSON).content(jsonData)).andReturn();
        ...
        assertEquals("1000000010", casesResponse.getGetPetitionTemp().getAgent1_Email());
        assertEquals("0001", casesResponse.getGetPlatform().getPetitionTypeDisplayName());
