...
public class TestQuesAnswerTest {
    ...
    public void test1() {
        ...
        // 将返回值从泛型转换成指定类型
        // QuestionnaireMails casesResponse =
        // objectMapper.convertValue(response.getData(), QuestionnaireMails.class);

        // 断言
        assertEquals(200, response.getCode());
        // assertEquals("1000000010", casesResponse.getQuestionnaireData());
        // assertEquals("0001", casesResponse.getQuestionnaireList());
    }
