...
public class TestInsRepliesTemp {
        ...
        // 测试方法声明注解
        @Test
        public void insRepliesTempTest2() {
                // 将要使用的数据转换成json类型的字符串
                ScreenInfo screenInfo = new ScreenInfo();
                // セッション.ユーザID
                screenInfo.setSessionId("U00260");
                // セッション.PlatformId
                screenInfo.setPlatformId("003");
                // 画面.購入商品
                screenInfo.setCommodity("申立テスト商品");
        ...
        // 测试方法声明注解
        @Test
        public void insRepliesTempTest3() {
                // 将要使用的数据转换成json类型的字符串
                ScreenInfo screenInfo = new ScreenInfo();
                // セッション.ユーザID
                screenInfo.setSessionId("U00270");
                // セッション.PlatformId
                screenInfo.setPlatformId("003");
                // 画面.購入商品
                screenInfo.setCommodity("申立テスト商品");
                ...
                screenInfo.setUseproductUrl("afa@gmail.com");
                // 画面.購入日
                screenInfo.setCommoditydate("20A0/08/05 15:00:00");
                // 画面.購入金額
                screenInfo.setPurchaseamount(1.4);
                // 画面.申立ての種類
                screenInfo.setPetitionKind("配送について,保証について");
        ...
        // 测试方法声明注解
        @Test
        public void insRepliesTempTest4() {
                // 将要使用的数据转换成json类型的字符串
                ScreenInfo screenInfo = new ScreenInfo();
                // セッション.ユーザID
                screenInfo.setSessionId("U00270");
