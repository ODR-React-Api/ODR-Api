...
public class TestGetPetitionsTemp {
    ...
    // 测试方法声明注解
    @Test
    public void getPetitionsTempTest4() {
        // 将要使用的数据转换成json类型的字符串
        SessionInfo sessionInfo = new SessionInfo();
        sessionInfo.setSessionId("U082fsh27-1a10-448d-a6d2-fb296d74f964");
        sessionInfo.setPlatformId("001");
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonData = objectMapper.writeValueAsString(sessionInfo);
        ...
        assertEquals("拡張項目の表示状態が0の画面表示成功!", response.getMsg());
        // 申立て人
        assertEquals("U082fsh27-1a10-448d-a6d2-fb296d74f964", casesResponse.getGetPetitionTemp().getPetitionUserId());
        // 申立Id
        assertEquals("FFFFSHC7B9C5425BB7D15DFCA7A59AE5", casesResponse.getGetPetitionTemp().getCasePetition());
        // 申立て人入力情報
        assertEquals("trnd0001+p02@gmail.com", casesResponse.getGetPetitionTemp().getPetitionUserInfo_Email());
        // 代理人1
        assertEquals("string", casesResponse.getGetPetitionTemp().getAgent1_Email());
        // 代理人2
        assertEquals("string", casesResponse.getGetPetitionTemp().getAgent2_Email());
        ...
        assertEquals("string", casesResponse.getGetPetitionTemp().getTraderUserEmail());
        // 商品名
        assertEquals("申立テスト商品", casesResponse.getGetPetitionTemp().getProductName());
        // 商品ID
        assertEquals(null, casesResponse.getGetPetitionTemp().getProductId());
        // 販売元名称
        assertEquals("string", casesResponse.getGetPetitionTemp().getTraderName());
    ...
    // 测试方法声明注解
    @Test
    public void getPetitionsTempTest5() {
        // 将要使用的数据转换成json类型的字符串
        SessionInfo sessionInfo = new SessionInfo();
        sessionInfo.setSessionId("U082fsh27-1a10-448d-a6d2-fb296d74f965");
        sessionInfo.setPlatformId("002");
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonData = objectMapper.writeValueAsString(sessionInfo);
        ...
        assertEquals("拡張項目の表示状態が0の画面表示成功!", response.getMsg());
        // 申立て人
        assertEquals("U082fsh27-1a10-448d-a6d2-fb296d74f965", casesResponse.getGetPetitionTemp().getPetitionUserId());
        // 申立Id
        assertEquals("FFFFSHC7B9C5425BB7D15DFCA7A59AE6", casesResponse.getGetPetitionTemp().getCasePetition());
        // 申立て人入力情報
        assertEquals("trnd0001+p01@gmail.com", casesResponse.getGetPetitionTemp().getPetitionUserInfo_Email());
        // 代理人1
        assertEquals("string", casesResponse.getGetPetitionTemp().getAgent1_Email());
    ...
    // 测试方法声明注解
    @Test
    public void getPetitionsTempTest6() {
        // 将要使用的数据转换成json类型的字符串
        SessionInfo sessionInfo = new SessionInfo();
        sessionInfo.setSessionId("U082fsh27-1a10-448d-a6d2-fb296d74f966");
        sessionInfo.setPlatformId("001");
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonData = objectMapper.writeValueAsString(sessionInfo);
        ...
        assertEquals("拡張項目の表示状態が0の画面表示成功!", response.getMsg());
        // 申立て人
        assertEquals("U082fsh27-1a10-448d-a6d2-fb296d74f966", casesResponse.getGetPetitionTemp().getPetitionUserId());
        // 申立Id
        assertEquals("FFFFSHC7B9C5425BB7D15DFCA7A59AE7", casesResponse.getGetPetitionTemp().getCasePetition());
        // 申立て人入力情報
        assertEquals("trnd0001+p01@gmail.com", casesResponse.getGetPetitionTemp().getPetitionUserInfo_Email());
        // 代理人1
        assertEquals("string", casesResponse.getGetPetitionTemp().getAgent1_Email());
    ...
    // 测试方法声明注解
    @Test
    public void getPetitionsTempTest7() {
        // 将要使用的数据转换成json类型的字符串
        SessionInfo sessionInfo = new SessionInfo();
        sessionInfo.setSessionId("U082fsh27-1a10-448d-a6d2-fb296d74f967");
        sessionInfo.setPlatformId("001");
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonData = objectMapper.writeValueAsString(sessionInfo);
        ...
        assertEquals("拡張項目の表示状態が0の画面表示成功!", response.getMsg());
        // 申立て人
        assertEquals("U082fsh27-1a10-448d-a6d2-fb296d74f967", casesResponse.getGetPetitionTemp().getPetitionUserId());
        // 申立Id
        assertEquals("FFFFSHC7B9C5425BB7D15DFCA7A59AE8", casesResponse.getGetPetitionTemp().getCasePetition());
        // 申立て人入力情報
        assertEquals("trnd0001+p01@gmail.com", casesResponse.getGetPetitionTemp().getPetitionUserInfo_Email());
        // 代理人1
        assertEquals("string", casesResponse.getGetPetitionTemp().getAgent1_Email());
    ...
    // 测试方法声明注解
    @Test
    public void getPetitionsTempTest8() {
        // 将要使用的数据转换成json类型的字符串
        SessionInfo sessionInfo = new SessionInfo();
        sessionInfo.setSessionId("U082fsh27-1a10-448d-a6d2-fb296d74f968");
        sessionInfo.setPlatformId("001");
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonData = objectMapper.writeValueAsString(sessionInfo);
        ...
        assertEquals("拡張項目の表示状態が0の画面表示成功!", response.getMsg());
        // 申立て人
        assertEquals("U082fsh27-1a10-448d-a6d2-fb296d74f968", casesResponse.getGetPetitionTemp().getPetitionUserId());
        // 申立Id
        assertEquals("FFFFSHC7B9C5425BB7D15DFCA7A59AE9", casesResponse.getGetPetitionTemp().getCasePetition());
        // 申立て人入力情報
        assertEquals("trnd0001+p01@gmail.com", casesResponse.getGetPetitionTemp().getPetitionUserInfo_Email());
        // 代理人1
        assertEquals("string", casesResponse.getGetPetitionTemp().getAgent1_Email());
