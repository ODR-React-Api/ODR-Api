...
public class MosListServiceImpl implements MosListService {
    ...
    public List<ReturnResult> getFuzzyQueryListInfo(String uid, String queryString) {
        ...
        // ケースの取得
        List<SelectUserInfoForCase> selectUserInfoForCasesFromPetiton = queryMapper.selectUserInfoForCasesFromPetiton(email);
        ...
        List<SelectUserInfoForCase> selectUserInfoForCasesFromTrader = queryMapper.selectUserInfoForCasesFromTrader(email);
        ...
        List<SelectUserInfoForCase> selectUserInfoForCasesFromMediator = queryMapper.selectUserInfoForCasesFromMediator(email);
