...
public class ReconciliationServiceImpl implements ReconciliationService {
    ...
    public int ActionHistoriesInsert(ActionHistories ActionHistories) {
        ActionHistories AcceptAction=new ActionHistories();
       //id赋予
        ...
        //申立人
        if (
            ActionHistories.getEmail().equals(UserSearch.getPetitionUserInfo_Email())||
        ...
        //相守人
        if (
            ActionHistories.getEmail().equals(UserSearch.getTraderUserEmail())||
