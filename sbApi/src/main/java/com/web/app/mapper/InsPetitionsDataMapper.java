...
public interface InsPetitionsDataMapper {
  ...
  void updateCaseRelations(UpdateCaseRelations updateCaseRelations);
  ...
  // TBL「案件（cases）」の新規登録
  void insertCases(InsertCases insertCases);

  // TBL「申立（case_petitions）」の更新
  void updateCasePetitions(UpdateCasePetitions updateCasePetitions);
  ...
  void insertCaseFileRelations(InsertCaseFileRelations insertCaseFileRelations);
